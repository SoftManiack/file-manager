  ...
  <div 
    ...
    <div class="d-flex justify-content-center mb-4">
      <div v-if="type == 'Directory'">
        <svg width="90" height="100"><use xlink:href="@/assets/icons/sprite.svg#folder-large"></use></svg>
      </div>
      <div class="mt-3 mb-2" v-if="type == 'File'">
        <svg width="65" height="75"><use xlink:href="@/assets/icons/sprite.svg#empry-file"></use></svg>
      </div>
    </div>
    <div class="d-flex">
      <div class="align-self-center c-block_name mt-1">{{name + "." + extension}}</div>
